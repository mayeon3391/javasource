...
public class StringEx3 {
    public static void main(String[] args) {
        ...
        // replace() 걸과는 새로운 문자열로 반환
        System.out.println("replace(old,new) " + str.replace("Hello", "안녕하세요")); // 원본 변경 불가
        System.out.println(str); // Hello World
        // 원본 변경
        str = str.replace("Hello", "안녕하세요");
        System.out.println(str); // 안녕하세요 World

        // replaceAll() - 정규식 사용가능, 전체 변경
        System.out.println(str.replaceAll("[a-z]", "1")); // 안녕하세요 W1111

        // replaceFirst() - 처음에 만나는 것만 변경
        str2 = "Hellollo";
        System.out.println(str2.replaceFirst("ll", "LL"));

        // substring() : 새로운 문자열 반환
        str2 = "java.lang.Object";
        System.out.println("특정 위치의 문자열 얻기 " + str2.substring(10)); // Object 문자열을 지정 위치 지점에서 잘라서 올려줌
        // 끝 위치는 포함하지 않음
        System.out.println("특정 위치의 문자열 얻기 " + str2.substring(5, 9)); // 끝나는 위치 지정
