...
public class ListEx5 {
    public static void main(String[] args) {
        ...
        System.out.println("SinkedList : " + add1(linkedList));
        System.out.println();
        System.out.println("=== 중간에 추가하기 ===");
        System.out.println("ArrayList : " + add2(arrayList));
        System.out.println("SinkedList : " + add2(linkedList));
        System.out.println();
        System.out.println("=== 중간에서 삭제하기 ===");
        System.out.println("ArrayList : " + remove2(arrayList));
        System.out.println("SinkedList : " + remove2(linkedList));
        System.out.println();
        System.out.println("=== 순차적으로 삭제하기 ===");
        System.out.println("ArrayList : " + remove1(arrayList));
        System.out.println("SinkedList : " + remove1(linkedList));
        System.out.println();
    }
