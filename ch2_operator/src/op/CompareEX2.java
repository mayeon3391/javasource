...
public class CompareEX2 {
    public static void main(String[] args) {
        ...
        // %19.17f : 19자리로 포현, 소수점 17자리까지 나오게
        System.out.printf("10.0 == 10.0f %b\n", 10.0==10.f); //true
        System.out.printf("0.1 == 0.1f %b\n", 0.1==0.1f); //false, 0.1을 double로 기록
        ...
        // 타입을 변환한다고 해도 double 원상태를 가지고 가기 때문에 false가 뜸
        // 실수형태를 저장할 때 Java에서는 double을 기본으로 가지고감
        // double로 저장하는 이유 - 오차없이 저장하기 위함
    }
}
