...
public class MyShop implements IShop {
    ...
    public void genProduct() {
        // 5개 제품 생성 후 배열각체에 담기(tv 2개, cellphone 3개)
        products[0] = new Tv("LG 울트라 HD", 1270000, "4K");
        products[1] = new Tv("삼성 QLED", 2980000, "QLED");
        products[2] = new CellPhone("갤럭시 S25", 1230000, "SKT");
        products[3] = new CellPhone("아이폰", 1300000, "U+");
